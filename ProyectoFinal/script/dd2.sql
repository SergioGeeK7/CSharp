...
INSERT INTO jornada VALUES (1,'Noche',1),(2,'Tarde',1),(3,'Manana',1);
...
CREATE FUNCTION getDescripcionTemas
(
@ID int
)
...
AS
  BEGIN
	SELECT codigo,cursos.titulo as 'Materia',
	  numeroHoras as 'Numero de Horas',valor as 'Costo', (SELECT dbo.getDescripcionTemas (cursos.codigo))   as 'temas',nombre as 'nombre Empleado'  
	  FROM cursos 
	  inner join empleados on  cursos.codEmpleado = empleados.codEmpleado
    -- EXEC GridCursos 
  END
GO
