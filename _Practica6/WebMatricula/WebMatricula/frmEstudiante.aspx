...
&nbsp;
                <asp:ImageButton ID="ibtnBuscar" runat="server" ImageUrl="~/Imagenes/Buscar.jpg" OnClick="ibtnBuscar_Click" Visible="False" style="height: 20px" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2" class="auto-style13">
                <asp:RadioButtonList ID="rblJornada" runat="server" AutoPostBack="True" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblJornada_SelectedIndexChanged">
                </asp:RadioButtonList>
            </td>
        </tr>
        <tr>
