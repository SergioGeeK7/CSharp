...
using System.Web;
using LibConexionBD;
using System.Data; // para los offline 
using System.Data.SqlClient; // para sql server,data reader
...
namespace WebMatricula
{
    public class clsEstudiante
    {
        ...
        private SqlDataReader Reader_Local; // contenedor de informacion que hay en el medio conectado
        #endregion
        ...
        {
            try // 62 min // http://localhost:1818/frmEstudiante.aspx
            {
                ...
                Reader_Local.Read(); // se pasa el primer registro de la consulta que tenga el reader
        ...
        public bool GrabarMaestro()
        {
            try
            {
                ...
                strSQL="EXEC USP_Esudiante_Grabar "+
                        " '" + strCodigo + "'," +
                               intNroDoc +", " +
                        "'" +strNombre + "', " +
                            Act + ", " +
